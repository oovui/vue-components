...
var script$7 = {
  ...
  methods: {
    ...
    //删除选项
    deleteItem: function deleteItem(e, tagName) {
      console.log("deleteItem", tagName);

      for (var i = 0; i < this.modelObject.value.length; i++) {
...
var __vue_render__$7 = function() {
  ...
  return _c(
    ...
    [
      !this.multiple
        ? _c("div", { staticClass: "select-section single" }, [
            _c(
              "span",
              {
                directives: [
      ...
      this.multiple
        ? _c(
            "div",
            { staticClass: "select-section multiple" },
            [
              _c(
                "span",
                {
              ...
              _vm._v(" "),
              _vm._l(_vm.multipleSelectedValue, function(item, index) {
                return _c(
                  "o-tag",
                  {
                    key: index,
  ...
  methods: {
    doSelect: function doSelect() {
      ...
      if (modelValue instanceof Array) {
        ...
        this.selectLabel.value = this.$slots.default[0].text; //change parent select v-model
