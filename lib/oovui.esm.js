...
var script$2 = {
  ...
  computed: {
    ...
    classes: function classes() {
      ...
      return _ref = {}, defineProperty(_ref, "input-".concat(this.type), !!this.type), defineProperty(_ref, "disabled", !!this.$attrs.hasOwnProperty("disabled")), defineProperty(_ref, "focused", !!this.focused), _ref;
    },
    valueModel: {
      get: function get() {
        return this.value;
