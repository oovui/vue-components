...
},{"./bundle-url":27}],31:[function(require,module,exports) {
var Vue // late bind
var version
...
exports.default = {
  name: 'app'
        ...
        var $8e36f5 = exports.default || module.exports;
      
      if (typeof $8e36f5 === 'function') {
        $8e36f5 = $8e36f5.options;
      }
    
        /* template */
        Object.assign($8e36f5, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "app" } }, [
    _c("h1", [_vm._v("vueui demo")]),
    _vm._v(" "),
    _c("hr"),
    _vm._v(" "),
    _c("div", { staticClass: "content-wrap" }, [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("router-link", { attrs: { to: "/buttons" } }, [_vm._v("Buttons")])
        ],
        1
      ),
      _vm._v(" "),
      _c("div", { staticClass: "right-demos" }, [_c("router-view")], 1)
    ])
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$8e36f5', $8e36f5);
          } else {
            api.reload('$8e36f5', $8e36f5);
          }
        }
...
},{"_css_loader":21,"vue-hot-reload-api":31,"vue":10}],17:[function(require,module,exports) {
'use strict';
...
exports.default = {
  name: 'About'
        ...
        var $215511 = exports.default || module.exports;
      
      if (typeof $215511 === 'function') {
        $215511 = $215511.options;
      }
    
        /* template */
        Object.assign($215511, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [_vm._v("\n  @oovui/vueui 开发demo展示页面\n")])
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$215511', $215511);
          } else {
            api.reload('$215511', $215511);
          }
        }
...
},{"vue-hot-reload-api":31,"vue":10}],23:[function(require,module,exports) {
var define;
var global = arguments[3];
...
var oneOf = exports.oneOf = Utils.oneOf;
...
var _index = require('../../packages/utils/index');
...
exports.default = {
  ...
  computed: {
    iconHtml: function iconHtml() {
      return _featherIcons2.default.icons[this.type].toSvg({
        color: this.color,
        width: this.size,
        height: this.size
      });
  ...
  props: {
    type: {
      validator: function validator(value) {
        return _index2.default.oneOf(value, ['activity', 'airplay', 'alert-circle', 'alert-octagon', 'alert-triangle', 'align-center', 'align-justify', 'align-left', 'align-right', 'anchor', 'aperture', 'archive', 'arrow-down-circle', 'arrow-down-left', 'arrow-down-right', 'arrow-down', 'arrow-left-circle', 'arrow-left', 'arrow-right-circle', 'arrow-right', 'arrow-up-circle', 'arrow-up-left', 'arrow-up-right', 'arrow-up', 'at-sign', 'award', 'bar-chart-2', 'bar-chart', 'battery-charging', 'battery', 'bell-off', 'bell', 'bluetooth', 'bold', 'book-open', 'book', 'bookmark', 'box', 'briefcase', 'calendar', 'camera-off', 'camera', 'cast', 'check-circle', 'check-square', 'check', 'chevron-down', 'chevron-left', 'chevron-right', 'chevron-up', 'chevrons-down', 'chevrons-left', 'chevrons-right', 'chevrons-up', 'chrome', 'circle', 'clipboard', 'clock', 'cloud-drizzle', 'cloud-lightning', 'cloud-off', 'cloud-rain', 'cloud-snow', 'cloud', 'code', 'codepen', 'command', 'compass', 'copy', 'corner-down-left', 'corner-down-right', 'corner-left-down', 'corner-left-up', 'corner-right-down', 'corner-right-up', 'corner-up-left', 'corner-up-right', 'cpu', 'credit-card', 'crop', 'crosshair', 'database', 'delete', 'disc', 'dollar-sign', 'download-cloud', 'download', 'droplet', 'edit-2', 'edit-3', 'edit', 'external-link', 'eye-off', 'eye', 'facebook', 'fast-forward', 'feather', 'file-minus', 'file-plus', 'file-text', 'file', 'film', 'filter', 'flag', 'folder-minus', 'folder-plus', 'folder', 'gift', 'git-branch', 'git-commit', 'git-merge', 'git-pull-request', 'github', 'gitlab', 'globe', 'grid', 'hard-drive', 'hash', 'headphones', 'heart', 'help-circle', 'home', 'image', 'inbox', 'info', 'instagram', 'italic', 'layers', 'layout', 'life-buoy', 'link-2', 'link', 'linkedin', 'list', 'loader', 'lock', 'log-in', 'log-out', 'mail', 'map-pin', 'map', 'maximize-2', 'maximize', 'menu', 'message-circle', 'message-square', 'mic-off', 'mic', 'minimize-2', 'minimize', 'minus-circle', 'minus-square', 'minus', 'monitor', 'moon', 'more-horizontal', 'more-vertical', 'move', 'music', 'navigation-2', 'navigation', 'octagon', 'package', 'paperclip', 'pause-circle', 'pause', 'percent', 'phone-call', 'phone-forwarded', 'phone-incoming', 'phone-missed', 'phone-off', 'phone-outgoing', 'phone', 'pie-chart', 'play-circle', 'play', 'plus-circle', 'plus-square', 'plus', 'pocket', 'power', 'printer', 'radio', 'refresh-ccw', 'refresh-cw', 'repeat', 'rewind', 'rotate-ccw', 'rotate-cw', 'rss', 'save', 'scissors', 'search', 'send', 'server', 'settings', 'share-2', 'share', 'shield-off', 'shield', 'shopping-bag', 'shopping-cart', 'shuffle', 'sidebar', 'skip-back', 'skip-forward', 'slack', 'slash', 'sliders', 'smartphone', 'speaker', 'square', 'star', 'stop-circle', 'sun', 'sunrise', 'sunset', 'tablet', 'tag', 'target', 'terminal', 'thermometer', 'thumbs-down', 'thumbs-up', 'toggle-left', 'toggle-right', 'trash-2', 'trash', 'trending-down', 'trending-up', 'triangle', 'truck', 'tv', 'twitter', 'type', 'umbrella', 'underline', 'unlock', 'upload-cloud', 'upload', 'user-check', 'user-minus', 'user-plus', 'user-x', 'user', 'users', 'video-off', 'video', 'voicemail', 'volume-1', 'volume-2', 'volume-x', 'volume', 'watch', 'wifi-off', 'wifi', 'wind', 'x-circle', 'x-square', 'x', 'youtube', 'zap-off', 'zap', 'zoom-in', 'zoom-out']);
      },
    ...
    size: {
      ...
      default: '18'
        ...
        var $5a8699 = exports.default || module.exports;
      
      if (typeof $5a8699 === 'function') {
        $5a8699 = $5a8699.options;
      }
    
        /* template */
        Object.assign($5a8699, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5a8699', $5a8699);
          } else {
            api.reload('$5a8699', $5a8699);
          }
        }
...
},{"feather-icons":23,"../../packages/utils/index":26,"vue-hot-reload-api":31,"vue":10}],18:[function(require,module,exports) {
'use strict';
...
//
//
        var $b9b53c = exports.default || module.exports;
      
      if (typeof $b9b53c === 'function') {
        $b9b53c = $b9b53c.options;
      }
    
        /* template */
        Object.assign($b9b53c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "div",
    [
      _c("OIcon", { attrs: { type: "x", color: "#323232", size: "30" } }),
      _vm._v(" "),
      _c("OIcon", {
        attrs: { type: "activity", color: "#48be58", size: "30" }
      }),
      _vm._v(" "),
      _c("OIcon", { attrs: { type: "airplay", color: "red", size: "20" } })
    ],
    1
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b9b53c', $b9b53c);
          } else {
            api.reload('$b9b53c', $b9b53c);
          }
        }
...
},{"./Icon.vue":24,"vue-hot-reload-api":31,"vue":10}],7:[function(require,module,exports) {
'use strict';
...
var _Buttons = require('./components/Buttons.vue');
...
var routes = [{ path: '/', component: _Home2.default }, { path: '/buttons', component: _Buttons2.default }];
...
},{"vue":10,"vue-router":17,"./components/Home.vue":15,"./components/Buttons.vue":18}],8:[function(require,module,exports) {
var global = arguments[3];
'use strict';
...
var _oovuiEsm = require('../dist/oovui.esm.js');

var _oovuiEsm2 = _interopRequireDefault(_oovuiEsm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_oovuiEsm2.default);
...
},{"vue":10,"./App.vue":6,"./router.js":7,"../dist/oovui.esm.js":8}],21:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/demos.3a6e4b27.map