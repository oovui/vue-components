...
(function (global, factory) {
	...
	*/
	...
	var script = {
	  ...
	  computed: {
	    iconHtml: function iconHtml() {
	      return feather$1.icons[this.type].toSvg({
	        color: this.color,
	        width: this.size,
	        height: this.size
	      });
	...
	function __vue_normalize__(template, style, script$$1, scope, functional, moduleIdentifier, createInjector, createInjectorSSR) {
	  ...
	  {
	    component.__file = "/usr/local/var/www/gitclone/oovuiProject/@oovui/vueui/packages/components/icon/Icon.vue";
	  }
	...
	var OButton = __vue_normalize__$1({ render: __vue_render__$1, staticRenderFns: __vue_staticRenderFns__$1 }, __vue_inject_styles__$1, __vue_script__$1, __vue_scope_id__$1, __vue_is_functional_template__$1, __vue_module_identifier__$1, __vue_create_injector__$1, undefined);
